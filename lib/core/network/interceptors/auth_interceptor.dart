...
class AuthInterceptor extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    // options.headers.addAll({"Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiMSIsImlhdCI6MTcwMzY2NzY4MiwiZXhwIjoxNzA0NTMxNjgyfQ.6sbidK1WC32O-RzMSMl95cv_gjm25fTinxE4aJPC5eo"});
  ...
  Future<void> onError(
    ...
    if (err.response?.statusCode == 401 && retryCount > 0) {
      ...
      Response tokenResp = await dio
          .post(NetworkRoute.refreshToken, data: {"refreshToken": refToken});
